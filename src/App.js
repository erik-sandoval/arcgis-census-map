...
const App = () => {
  ...
  useEffect(() => {
    ...
    loadModules(
      ...
      { css: true }
    ).then(([Map, MapView, GeoJSONLayer, PopupTemplate, LayerList]) => {
      const statesTemplate = new PopupTemplate(state);

      const countyTemplate = new PopupTemplate(county);

      // creating layers for the geojson files in public folder
      ...
      // adding a layer listing to the top-right
    ...
    <div>
      ...
      <div className="contact-info">
        <div className="inner-box">
          <h3>Erik Sandoval</h3>
          <a
            href="https://github.com/erik-sandoval/arcgis-census-map"
